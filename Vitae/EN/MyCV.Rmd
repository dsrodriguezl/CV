...
tribble(
   ...
   "Presentation: Variation of the relative abundance and diet of dogs (\\textit{C. lupus familiaris}) on a gradient of human presence in a natural preserve of the civil society (Tabio, Cundinamarca)", "May 2016", "Symposium of bachelor theses 2016-I, Faculty of Science, Universidad Nacional de Colombia", "Bogotá, Colombia", NA,
  ...
  "Flash presentation: Variation of the cuticular hydrocarbon profiles among honeybees workers with different social roles and between different \\textit{Apis mellifera} subspecies", "March 24 2021", "68th Annual Meeting of the Working Group of the Institutes for Bee Research e.V.", "Virtual Meeting via Zoom", NA,
  
  "Poster: Variation of cuticular hydrocarbon profiles among honeybee workers with different social roles and between different \\textit{Apis mellifera} subspecies", "August 31 2021", "113th Meeting of the German Zoology Society", "Virtual Meeting via Gather", NA
